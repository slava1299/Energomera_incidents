...
/// <summary>
/// Результат процедуры получения инцидентов [dbo].[mas_telegram_alarms_start].
/// </summary>
[Keyless]
public class ProcMasTelegramAlarmsStartProjection
{
    /// <summary>
